...
export default async function BowlingAdminPage() {
  ...
  const totalLanes = committedRegistrations.reduce((sum, registration) => sum + registration.laneCount, 0);
