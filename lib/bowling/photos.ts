export const bowlingPhotos = {
  hero: {
    src: "/bowling/christmas-in-july-sand-snowman.jpeg",
    alt: "A sand snowman wearing a Santa hat and sunglasses on a sunny beach",
    source: "AdobeStock_70581017.jpeg",
  },
  mission: {
