export const bowlingCopy = {
  ...
  impact: {
    headline: "Your team helps students walk in prepared.",
    cards: [
      {
        title: "Backpacks",
        body: "Durable backpacks for students beginning a new school year.",
      },
      {
        title: "School Supplies",
        body: "Essential classroom items that help students start with confidence.",
      },
      {
        title: "Family Relief",
        body: "Practical support that eases the pressure families feel before school begins.",
      },
      {
        title: "Restoration",
        body: "A simple act of generosity that opens the door to trust, relationship, and hope.",
      },
    ],
  },
  registration: {
    ...
    sponsor:
      "Sponsorships help cover the event and provide direct support for students and families preparing for the school year.",
    lane:
