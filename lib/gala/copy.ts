export const galaCopy = {
  ...
  impact: {
    eyebrow: "What Your Support Carries",
    headline: "A night of generosity becomes a year of presence.",
    intro:
      "When you attend, sponsor, give, or invite others into the room, you help City Center continue the kind of work that cannot be rushed and should not be seasonal.",
    cards: [
      {
        title: "Physical Relief",
        body: "Food, clothing, hygiene, and essential needs offered with dignity.",
      },
      {
        title: "Emotional Restoration",
        body: "Mentoring, steady relationships, care, and belonging for students and families.",
      },
      {
        title: "Dignity",
        body: "Every person deserves respect, support, and the chance to be known beyond their circumstances.",
      },
      {
        title: "Hope",
        body: "There is potential in everyone. A hard chapter does not get the final word.",
      },
    ],
  },
  rallyCry: {
    headline: "We don't have to serve.\nWe get to serve.",
    body: "That joy is the heartbeat of City Center, and it is the reason this evening matters.",
  },
  evening: {
    eyebrow: "The Evening",
    ...
    list: [
      "Cocktail reception and guest check-in",
  ...
  auction: {
    eyebrow: "Auction",
    headline: "Bid on meaningful experiences and help fund the work.",
    body:
  ...
  voices: {
    ...
    headline: "The same students who are learning to tell stories are helping City Center tell its own.",
    body:
      "Voices of OKC is part of City Center's storytelling ecosystem, giving students a place to learn production, ask better questions, and help elevate the people shaping Oklahoma City.\n\nAt the Gala, that same spirit of storytelling carries the room. We gather not only to raise funds, but to listen closely to the stories of students, families, neighbors, and leaders who remind us why this work matters.",
    cta: "Explore Voices of OKC",
  },
};
